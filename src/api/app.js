 ...
 * @property {LoginRunService} [loginRunService]
 * @property {object} [probe]
 * @property {object} [probeOptions]
 * @property {() => string} [now]
 * @property {() => string} [idFactory]
 * @property {number|string|undefined} [ttlMs]
 * @property {number|string|undefined} [processKeepAliveMs]
 * @property {number|string|undefined} [connectTimeoutMs]
 * @property {number|string|undefined} [waitMs]
 * @property {number|string|undefined} [maxActions]
 * @property {number|string|undefined} [actionWaitMs]
 */

/**
 * @param {BuildAppOptions} options
